...
class shoppregcust {
    ...
    private $shopp_version = array('1.1.5', '1.1.6', '1.1.7', '1.1.8', '1.1.9');
    ...
    function setup_options()
    {
        ...
        $this->options = $this->pluginAdminMenu->set_options($html_options = array (
            ...
            array( "name" => "General Settings",
            	   "type" => "section"),
            array( "name" => "To use this plugin just place [shopp_regform] to add a customer registration form.", "type" => "p"),
